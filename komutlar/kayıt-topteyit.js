...
if(!message.member.roles.cache.some(r => ['791342695120896031', '791342787969679421'].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))return message.reply("Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.")  
